...
public class T07EqualsHashcodeTest {
	 ...
	 * 두 객체가 같으면 equals() 호출했을 때 true를 반환해야 한다. 즉, 객체 a, b가 같다면 a.equlas(b)와
	 ...
	 * 매핑정보를 기반으로 한 정수값을 반환한다. 그러므로, 클래스에서 hashCode()메서드를 override하지 않으면 절대로 두 객체가
	 * 같은 것으로 간주될 수 없다.
	 */
