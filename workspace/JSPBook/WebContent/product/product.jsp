...
<body>
	...
	include 액션 태그를 작성  -->
	<jsp:include page="menu_product.jsp" />
	<div class="jumbotron">
		<!-- 내용 드루와 -->
		<div class="container">
	...
	<div class="container">
		<div class="row" align="center">
			<div class="col-md-5">
				<img alt="${productVO.pname}" title="${productVO.pname}" src="/resources/images/${productVO.filename}" style="height: 80%; width:100%;">
			</div>
			<div class="col-md-6">
	...
	<!-- ============= 상품 상세 끝 ===============  -->
	<jsp:include page="footer_product.jsp" />
</body>
</html>	