...
*/
	    ...
	    public static void main(String[] args) {
	    	...
	    	System.out.println("myCity1의 ordianl : " + myCity1.ordinal());
	    	System.out.println();
	    	System.out.println("myCity2 : " + myCity2.name());
	    	System.out.println("myCity2의 ordianl : " + myCity2.ordinal());
	    	System.out.println("========================================");
	    	
	    	Season ss = Season.valueOf("여름");
	    	//Season ss = Season.여름; 과 똑같다. 
	    	...
	    	for(City city : City.values()) {
	    	  ...
	    	  // 배열이라 향상된 for문을 쓸 수 있다. (배열과 iterable 한 것만 쓸 수 있음)
	    	  // city.toString()을 city.name()으로도 할 수 있다. 
	    	...
	    	//                   -> 컴파일 되지 않음. 잘못된 비교를 컴파일러에서 막는다. 
	    	//                   -> 상수는 enum 상수를 쓰면 좀 더 안전한 코드를 만들수 있다.
	    	...
	    	// enum 상수들은 모두 comparable 이 구현된 상수?
	    }
}
