...
/*
    ...
    notify() 또는 notifyAll() => WAIT-SET영역에 있는 스레드를 깨워서 실행될 수 있도록
                                                     한다. (notify()는 하나, notifyAll()은 전부를 깨운다.)
                                                     
    => wait()와 notify(), notifyAll()은 동기화 영역에서만 실행될 수 있고, Object 클래스에서
           제공하는 메서드이다.                                                     
 */
